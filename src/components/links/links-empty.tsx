...
export function LinksEmpty() {
  ...
  return (
    <div className='grid place-items-center space-y-4 rounded-lg border border-neutral-300 bg-white px-6 py-16 shadow-md dark:border-neutral-800 dark:bg-neutral-950 sm:px-16'>
      ...
      {!query && <Button onClick={() => pushModal('CreateLink')}>Create your first link</Button>}
